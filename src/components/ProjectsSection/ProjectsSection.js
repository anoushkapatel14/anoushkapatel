      ...
      <div className="projects__wrap">
        <article className="individual-project">
          ...
          <p className="projects__text">
            ...
            needed! Two users with linked accounts are shown the same films.
            Users are able to swipe on films they want to watch, and if both
            users swipe right on a film, they get a 'match' and that film is put
            in their matches page. This app aims to stop endless scrolling when
            deciding what film to watch, and instead use YouChoose to find films
            both users are interested in watching.
          </p>
        ...
        <article className="individual-project">
          ...
          <p className="projects__text">
            A portfolio website built for an opera singer to showcase her work
            and upcoming events.
          </p>

          <Link
            to="https://clairewardsoprano.netlify.app/"
