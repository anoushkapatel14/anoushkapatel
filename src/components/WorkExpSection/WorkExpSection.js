      ...
      <div className="work-exp__wrap">
        ...
        <article className="previous-roles">
          ...
          <div className="previous-roles__div">
            ...
            <p className="previous-roles__text">2022-2023</p>
          </div>
          ...
          <div className="previous-roles__div">
            ...
            <p className="previous-roles__text">
              💸 Budget Maestro: Steered the Music department's financial ship,
              strategically maximizing budgets to benefit both pupils and the
              department.
            </p>
            ...
            <p className="previous-roles__text">
              🎤 Captivating Presenter: Engaged audiences of 300+ at regular
              assemblies, sharing insights and fostering a sense of community
        ...
        <article className="previous-roles">
          <div className="previous-roles__div">
            <h3 className="previous-roles__subheading">Role:</h3>
            <p className="previous-roles__text">
              Head of Music and Music Technology
            </p>
            <p className="previous-roles__text">Fortismere School, London</p>
            <p className="previous-roles__text">2021-2021</p>
          </div>
        ...
        <article className="previous-roles">
          <div className="previous-roles__div">
            <h3 className="previous-roles__subheading">Role:</h3>
            <p className="previous-roles__text">Second in charge of Music </p>
            <p className="previous-roles__text">Ashmole Academy, London</p>
            <p className="previous-roles__text">2017-2021</p>
          </div>

          <div className="previous-roles__div">
            <h3 className="previous-roles__subheading">Responsibilities</h3>
            <p className="previous-roles__text">
              🎵 Music Educator: Taught music to students aged 11-18 at a
              comprehensive school in North London.
            </p>
            <p className="previous-roles__text">
              📚 A Level Leader: Led on A Level music, providing engaging and
